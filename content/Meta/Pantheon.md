Without special knowledge, moderately well-read characters can be assumed to have basic knowledge of the pantheon, so if someone is talking about a god, it's probably one of these:
